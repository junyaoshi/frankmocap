...
class DemoOptions():
    ...
    def __init__(self):
        ...
        parser.add_argument('--input_dir', type=str, default=None,
                            help="""Directory to video, image, or a folder where image files exists""")
        ...
        parser.add_argument('--out_parent_dir', type=str, default=None,
                            help='Parent directory of folders of output images. (Used with --input_dir)')
        ...
        parser.add_argument("--renderer_type", type=str, default="opengl",
                            choices=['pytorch3d', 'opendr', 'opengl_gui', 'opengl', 'None'],
